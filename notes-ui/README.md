...
* Comfortable long-form writing experience
...
* Custom theme system with reusable color tokens
...
* Fully styled using `StyleSheet.create()`
* Dynamic theme-based styling
* Reusable spacing and typography constants
